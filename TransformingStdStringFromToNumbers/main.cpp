...
int main()
{
    ...
    long long_var = std::stoi(number_str);
    ...
    //std::string number_str2 = "-34.567"; //Resulting unsigned long and long long underflow and become huge numbers of their type
    std::cout << std::endl;
    ...
    std::cout << "float_var2 : " << float_var2 << std::endl;
    std::cout << "sizeof(float_var2) : " << sizeof(float_var2) << std::endl;

    double double_var2 = std::stod(number_str3);
    std::cout << "double_var2 : " << double_var2 << std::endl;
    std::cout << "sizeof(double_var2) : " << sizeof(double_var2) << std::endl;
