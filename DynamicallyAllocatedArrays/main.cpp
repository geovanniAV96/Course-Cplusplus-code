...
int main()
{
    ...
    // Different ways you can declare an array dynamically and how they ara initialized
    ...
    if(p_scores)
    {
        std::cout << "size of scores (it's a regulat pointer) : " << sizeof(p_scores) << std::endl;
