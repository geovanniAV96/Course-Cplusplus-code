...
int main()
{
    ...
    std::cout << "address of string1 : " << &string << std::endl;
    std::cout << "address of string2 : " << &string << std::endl;
    ...
    //Changes to the original string are reflected int the string_view
    char word [] {"Dog"};
