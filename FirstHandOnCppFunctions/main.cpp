...
void say_hello()
{
    ...
    return; //You could omit this return statement for function returning void
} 
...
//What we have inside the function are actually COPIES of the arguments passed to the fuction
