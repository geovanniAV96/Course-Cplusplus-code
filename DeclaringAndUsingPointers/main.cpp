...
int main()
{
    ...
    int* p_number6{}, other_int_var6{}; // Confusing as you wonder if other_int_var6 is also a pointer
    ...
    // It is beeter to separate these declarations on different lines though
    int *p_number7{};
    int other_int_var7{}; // No room for confusion this time

    // Initializing pointers an assigning them data
    ...
    std::cout << "address : " << p_int2 << std::endl; // Getting address of pointed value
