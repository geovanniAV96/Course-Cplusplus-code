...
int main()
{
    ...
    signed short signed_short {122}; // same as short
    signed short int signed_short_int {-456}; // same as short int
    unsigned short int unsigned_short_int {456}; // 2 Bytes only positives
    
    std::cout << "Short variable : " << short_int << " , size : " << sizeof(short) << " bytes" << std::endl;
    ...
    signed int signed_int {77}; // same as int
    unsigned int unsigned_int {77}; // only positives
    ...
    signed long int signed_long_long {444};
