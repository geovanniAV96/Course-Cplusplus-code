...
int main()
{
    ...
    unsigned char unsigned_char {53u}; //55u would fail because of narrowing
    ...
    unsigned short int unsigned_short_int {5678U}; // U is used for unsigned
    ...
    //4 or 8 Bytes
    long long_var {88L}; //L is used for long
    ...
    //Assigment and functional dont catch that.
