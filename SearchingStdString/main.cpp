...
int main()
{
    ...
    //Finds the starting index where the str substring is found in the string where we call the method 
    ...
    //Using std::string::npos to check if search was succesfull or failed
    ...
    //Find(2)
    //Can specify the position where we want the search to start using the second parameter of the method
    ...
    found_pos3 = string4.find(c_string4,2);
    if(found_pos3 != std::string::npos)
    {
        std::cout << c_string4 << " found at position : " << found_pos3 << std::endl;
    }
    else
    {
