...
int main()
{
    ...
    std::cout << "str3 contains " << str2.size() << " characters" << std::endl; //0
    ...
    std::cout << "str3 contains " << str2.length() << " characters" << std::endl; //0
    ...
    std::cout << "str8 size : " << str1.size() << std::endl; //11
