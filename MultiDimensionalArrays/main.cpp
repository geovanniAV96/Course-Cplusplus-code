...
int main()
{
    ...
    int packages2[][5]
    {
        ...
        {7,8,9},
        {10,11,12},
        {100,110,120} //Can add as many triplets in package2 as we want
    };
    ...
    //FOr 3d and really any multidimensional array, you have to specify the number of elements
    //in []'s, only the left most is not mandatory. Below is the example for 3D reproduced.
    ...
    //If you put less elements than the amount specified in the declaration, the compiler will
    //automatically fill out those left out with 0 or '\0' if the array is of chars. Change the
    //array to int house_block[][5][4], and because all inner arrays have 3 elements, the fourth
